...
const editTask = (e) => {
    ...
    editButton = parentNode.childNodes[1].childNodes[1].childNodes[1];

    taskTitle.setAttribute('contenteditable', 'true');
    taskDescription.setAttribute('contenteditable', 'true');
    taskType.setAttribute('contenteditable', 'true');
    editButton.setAttribute('class', 'fa-solid fa-xmark');

    submitButton.setAttribute('onclick', 'saveEdit.apply(this,arguments)');
    editButton.parentNode.setAttribute('onclick', 'cancelEdit.apply(this,arguments)');
...
const saveEdit = (e) => {
    ...
    const editButton = parentNode.childNodes[1].childNodes[1].childNodes[1];
    ...
    submitButton.setAttribute('data-bs-target', '#shoowTask');
    editButton.setAttribute('class', 'fas fa-pencil-alt');
    editButton.parentNode.setAttribute('onclick', 'editTask.apply(this,arguments)');
